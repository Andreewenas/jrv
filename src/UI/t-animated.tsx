...
export function TextAnimate({
    ...
    // Periksa apakah children adalah elemen React
    const isReactElement = typeof children !== "string";
  
    // Ambil teks jika children adalah string, fallback ke string kosong
    const textContent = !isReactElement ? String(children) : "";
